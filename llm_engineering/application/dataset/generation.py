...
"""
    ...
    def get_prompt(cls, document: CleanedDocument) -> GenerateDatasetSamplesPrompt:
        assert cls.prompt_template_str is not None, (
...
class InstructionDatasetGenerator(DatasetGenerator):
    ...
    must ask to write about a specific topic only related to football, formations and tactics contained in the context. \ 
    ...
    Instructions must never explicitly mention a context or an extract. \
    Instructions must be self-contained and general. \
    Answers must imitate the writing style of the context. \
    
    Example instruction: What is the 4 2 4 formation? \
    Example answer: The 4 2 4 formation has a back line of four defenders two centre backs and two full backs. \
    Ahead of the defenders, a central midfield pair operates in the next line, with a high attacking line of four just ahead. \
    It is typically an aggressive front line, as a result of the wingers or wide midfielders starting and remaining very high, either side of the centre forwards. \
